  ...
  <div class="row text-center g-4">
    <div class="col-md-4">
      <div class="p-4 bg-dark text-light rounded shadow">
        <h4><i class="fa-brands fa-html5 text-danger"></i> HTML5</h4>
        <p>Semántica moderna y accesibilidad.</p>
      </div>
    </div>
    <div class="col-md-4">
      <div class="p-4 bg-dark text-light rounded shadow">
        <h4><i class="fa-brands fa-css3-alt text-primary"></i> CSS3</h4>
        <p>Responsive y diseño elegante.</p>
      </div>
    </div>
    <div class="col-md-4">
      <div class="p-4 bg-dark text-light rounded shadow">
        <h4><i class="fa-brands fa-bootstrap text-purple"></i> Bootstrap</h4>
